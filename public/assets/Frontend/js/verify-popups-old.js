...
const assessmentSuccessMessageP = "Your HappiLIFE Screening Summary is ready for download. It’s also available in your Dashboard & will be shared on your shared mail ID.";
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data['message'] == "Successfully, Mobile OTP is verified.!" || data['message'] == "Successfully, Email OTP is verified.!") {
        if (otpType == "email") { showToast(emailVerifiedMessage); user.emailVerify = true; }
