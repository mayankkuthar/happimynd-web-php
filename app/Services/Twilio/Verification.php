...
class Verification implements SMSService
{
    ...
    public function __construct($client = null, string $verification_sid = null)
    {
        ...
        $this->client = $client;
        $this->verification_sid = $verification_sid ?: config('twilio.verification_sid');
    }
    ...
    public function startVerification($phone_number, $channel)
    {
        try {
            ...
            return ["Verification failed to start: {$exception->getMessage()}"];
        }
    }
