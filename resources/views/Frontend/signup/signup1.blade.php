...
@section('title', 'Happimynd | Signup - Sponser')
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-5 col-md-6">
          <div class="signup_form signup_form-fillsponser">
            <form method="GET" action="{{ route('verifyCode') }}" id="SponserSelectForm">
              <h1>Welcome</h1>
              <div class="signup_form__select">
                <h2>Select Name of Sponsor</h2>
              ...
              <div class="signup_form__hmcode">
                <h2>HappiMynd Code</h2>
                <input type="text" placeholder="HappiMynd Code" value="" name="happimyndCode" />
              </div>
          ...
          <div class="signup_form signup_form-create-profile">
            <form method="POST" id="signupForm" action="{{ route('user.signup.post') }}">
                @csrf
                <input type="hidden" name="happimyndCode">
                <input type="hidden" name="organization_id">
                <input type="hidden" name="signup_type" value="organization">
              ...
              <div class="signup_form__age">
                ...
                <div class="sendfull__report__checkbox__input signup_form__age__verifyage text-danger">
