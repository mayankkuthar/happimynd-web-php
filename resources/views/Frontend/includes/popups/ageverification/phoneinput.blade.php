<div class="modal fade" id="phoneInput" tabindex="-1" data-show="true" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog sendfullreport__popup">
    <div class="modal-content">
      ...
      <div class="sendfullreport__popup__content">
        <h1>Parent’s Phone</h1>
        <p>We will send a confirmation code on this phone.</p>
        <form class="sendfullreport__popup__form">
          ...
          <div class="sendfullreport__popup__form__button">
            <button type="button" onclick="generateGuardianOTP('mobile');">Continue</button>
          </div>
        </form>
      </div>
    </div>
