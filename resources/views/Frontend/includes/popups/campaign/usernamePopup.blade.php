<div class="modal fade" id="usernameForCampaign" tabindex="-1" data-show="true" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered sendfullreport__popup">
    <div class="modal-content">
      ...
      <div class="sendfullreport__popup__content">
        ...
        <p>Sit back & Relax! We will find your account & help reset password.
          </p>
        <form class="sendfullreport__popup__form forget_username" action="{{ route('check-username-exists') }}" method="POST" id="forget__pass">
          @csrf
          <div class="sendfullreport__popup__form__input">
            <h2>Username</h2>
            <input type="text" name="username" id="forget__pass__username" placeholder="Username or E-mail">
            <span id="error-message-forgetpass" style="display: none;" class="error-message"></span>
          </div>
