<div class="modal fade" id="verifyotpmobile" tabindex="-1" data-show="true" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered sendfullreport__popup">
    <div class="modal-content">
      ...
      <div class="sendfullreport__popup__content">
        <h1>Check your mobile</h1>
        <p>Verification code sent on your Mobile. Use here to reset your password.</p>
        <form class="sendfullreport__popup__form" id="forget__otp_code_mobile" action="{{ route('verifyOtpByCode', ['type'=>'mobile']) }}" method="POST">
          @csrf
          <div class="sendfullreport__popup__form__input">
            <h2>Code</h2>
            <input type="text" placeholder="Enter your code">
            <span id="error-message-forgetpass-otp-mobile" style="display: none;" class="error-message"></span>
          </div>
          <input type="text" id="username__mobile_forget" name="username" value="" hidden>
