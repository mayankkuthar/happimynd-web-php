  ...
  <div class="modal-dialog sendfullreport__popup">
    <div class="modal-content">
      ...
      <div class="sendfullreport__popup__content">
        <h1>E-Mail Required</h1>
        <p>We will send you the further Instructions on your Email in 24 hours.</p>
        <form class="sendfullreport__popup__form" >
          ...
          <div class="sendfull__report__checkbox">
            <div class="sendfull__report__checkbox__input">
              <input class="qcheckbox" type="checkbox" id="useemail" name="useemail" checked>
              <label for="useemail"><span>Use Email in case I forget my password.</span></label>
            </div>
            <div class="sendfull__report__checkbox__input">
              <input class="qcheckbox" type="checkbox" id="sendcopy" name="sendcopy" checked>
              <label for="sendcopy"><span>Use Email to send copy of summary.</span></label>
            </div>
            <div class="sendfull__report__checkbox__input">
              <input class="qcheckbox" type="checkbox" id="subscribe" name="subscribe" checked>
              <label for="subscribe"><span>Subscribe me to blogs/articles/newsletters or any other subscriptions from HappiMynd for your updation.</span></label>
            </div>
          </div>
        </form>
      </div>
