          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
              <div data-aos="fade-up" data-aos-duration="1200" data-aos-once="true" class="footer__lists">
                <h1>Services</h1>
                <ul>
                  <li><a href="{{ route('services') }}/#happilife" onclick="getHashValue('happilife');"><span id="life1"></span></a></li>
                  <li><a href="{{ route('services') }}/#happiapp" onclick="getHashValue('happiapp');"><span id="app1"></span></a></li>
                  <li><a href="{{ route('services') }}/#happichat" onclick="getHashValue('happichat');"><span id="chat1"></span></a></li>
                  <li><a href="{{ route('services') }}/#happitalk" onclick="getHashValue('happitalk');"><span id="talk1"></span></a></li>
                  <li><a href="{{ route('services') }}/#happispace" onclick="getHashValue('happispace');"><span id="space1"></span></a></li>
                </ul>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
