                        ...
                        <tr>
                          ...
                          <td style="text-align: center;">
                            @if(in_array($row->id , $already_mapped_psychologist))
                              <a href="{{url('admin/un-map-psy-with-guide').'/'.$row->id}}" class="btn btn-primary">Un-Map with Guide</a>
                            @else
                              <a href="{{url('admin/map-psy-with-guide').'/'.$row->id}}" class="btn btn-primary">Map with Guide</a>
                            @endif
                          </td>
                        </tr>
                        @endforeach
