            ...
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                  ...
                  <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="sub_course_name" id="name" value="{{$sub_couse_detail->sub_course_name}}" required/>
                  </div>


                  <div class="form-group">
                       <label for="reg_price" style="font-size: 17px;">After:</label>
                       <select name="count_for_sequence" class="form-control">
