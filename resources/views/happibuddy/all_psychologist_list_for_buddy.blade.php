                        ...
                        <tr>
                          ...
                          <td style="text-align: center;">
                            @if(in_array($row->id , $already_mapped_psychologist))
                              <a href="{{url('admin/un-map-psy-with-buddy').'/'.$row->id}}" class="btn btn-primary">Un-Map with BUDDY</a>
                            @else
                              <a href="{{url('admin/map-psy-with-buddy').'/'.$row->id}}" class="btn btn-primary">Map with BUDDY</a>
                            @endif
                          </td>
                        </tr>
                        @endforeach
