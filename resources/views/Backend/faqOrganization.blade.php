<x-backend-layout>
  ...
  <x-slot name="content">
    ...
    <div class="right_col" role="main">
      <br />
      <h3 align="center">Upload FAQ Organization</h3>
      <br />
      @if($faqs)
        @foreach($faqs->content as $faq)
          <form method="POST" action="{{ route('admin.staticData.faqOrganizationPost') }}" id="term-{{ $faq->id }}">
          @csrf
    ...
    <x-slot name="js">
      ...
      <script type="text/javascript">
        ...
        function addInputFields() {
          ...
          $('<form>', { action: "{{ route('admin.staticData.faqOrganizationPost') }}", method: 'POST' }).append(
